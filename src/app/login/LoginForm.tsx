...
import { login, getUserProfile } from '@/features/auth/services/authService';
      ...
      <div className="z-10 space-y-6">
        ...
        <div className="max-w-xs space-y-3">
          <h2 className="text-3xl font-bold leading-tight text-white">
            Your business,
            <br />
            <span className="text-blue-500">fully organized.</span>
          </h2>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-xs text-blue-500/70 hover:text-blue-500 transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
